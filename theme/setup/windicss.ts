...
export default defineWindiSetup(() => ({
    ...
    shortcuts: { // custom the default background
        'bg-main': 'bg-gradient-to-r from-white to-secondary-50 dark:(bg-gradient-to-r from-primary-500 to-primary-600)',
    ...
    plugins: [
        aspectRatioPlugin, plugin(function ({addUtilities, theme, variants}) {
            const newUtilities = {
                '.flip-y': {
